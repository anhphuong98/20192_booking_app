...
public class DataOrder implements Serializable {
    ...
    public DataOrder(int id, int user_id, String address, String name_recieve, double phone_recieve, String note, float ship_price, String time, int status, int shipper_id, int store_id, DataStore store) {
        this.id = id;
